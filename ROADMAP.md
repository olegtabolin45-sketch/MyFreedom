...
- [~] Дашборд (главная страница пользователя). 🟡 Концепт: профиль, KPI-карточки, анимированный area-график роста, кольцо достижения цели; данные читаются из PostgreSQL через `GET /api/goals`. Будет дорабатываться.
